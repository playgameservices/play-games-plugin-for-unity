...
namespace GooglePlayGames.Android
{
    ...
    internal class AndroidSnapshotMetadata : ISavedGameMetadata
    {
        ...
        public string Filename
        {
            get
            {
                return mJavaMetadata.Call<string>("getUniqueName");
            }
        }
        ...
        public string Description
        {
            get
            {
                return mJavaMetadata.Call<string>("getDescription");
            }
        }
        ...
        public string CoverImageURL
        {
            get
            {
                return mJavaMetadata.Call<string>("getCoverImageUrl");
            }
        }
        ...
        public TimeSpan TotalTimePlayed
        {
            get
            {   
                return TimeSpan.FromTicks(mJavaMetadata.Call<long>("getPlayedTime"));
            }
        }
