...
namespace GooglePlayGames
{
    ...
    {
        [MenuItem("Assets/Google Play Games/Documentation/Plugin Getting Started Guide...", false, 100)]
        public static void MenuItemGettingStartedGuide()
        {
            Application.OpenURL(GPGSStrings.ExternalLinks.GettingStartedGuideURL);
        }

        [MenuItem("Assets/Google Play Games/Documentation/Google Play Games API...", false, 101)]
        public static void MenuItemPlayGamesServicesAPI()
        {
            Application.OpenURL(GPGSStrings.ExternalLinks.PlayGamesServicesApiURL);
        }

        [MenuItem("Assets/Google Play Games/Downloads/Google+ SDK (iOS)...", false, 200)]
        ...
        [MenuItem("Assets/Google Play Games/Downloads/Google Play Games C++ SDK (iOS)...", false, 201)]
        ...
        [MenuItem("Assets/Google Play Games/Downloads/Google Play Games SDK (Android)...", false, 203)]
        ...
        [MenuItem("Assets/Google Play Games/About/About the Plugin...", false, 300)]
        ...
        [MenuItem("Assets/Google Play Games/About/License...", false, 301)]
