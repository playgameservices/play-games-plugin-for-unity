...
namespace GooglePlayGames
{
  ...
  public class GPGSIOSSetupUI : EditorWindow
  {
    ...
    void DoSetup()
    {
      PerformSetup(mClientId, mBundleId, null);
    }
    ...
    public static void PerformSetup(string clientId, string bundleId, string nearbySvcId)
    {
        ...
        if (nearbySvcId != null)
        {
            NearbyConnectionUI.PerformSetup(nearbySvcId, false);
        }
