...
class InvitePlayerUiRequest implements HelperFragment.Request {
    ...
    protected Task<Intent> getIntent(Activity activity) {
        ...
        TurnBasedMultiplayerClient turnBasedMultiplayerClient = Games.getTurnBasedMultiplayerClient(activity, account);
        return turnBasedMultiplayerClient.getSelectOpponentsIntent(minPlayers, maxPlayers);
    }
