...
// Note: don't edit or remove the GPGSID markers next to the Google Play Games IDs.
// They are used by the pre-commit scripts to check to see if you're trying to
// commit something that's not a placeholder to the repository.
...
public class Settings  {
    ...
    public const string Event =
        "PLACEHOLDER - PUT YOUR EVENT ID HERE"; // <GPGSID>
}
