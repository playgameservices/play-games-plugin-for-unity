...
{
    WidgetConfig TitleCfg = new WidgetConfig(0.0f, -0.2f, 1.0f, 0.2f, 100, "QuizRacer");
    WidgetConfig QuickMatchCfg = new WidgetConfig(0.0f, -0.1f, 0.8f, 0.1f, 60, "Quick Match");
    WidgetConfig InviteCfg = new WidgetConfig(0.0f, 0.0f, 0.8f, 0.1f, 60, "Send Invitation");
    WidgetConfig InboxCfg = new WidgetConfig(0.0f, 0.1f, 0.8f, 0.1f, 60, "Accept Invitation");
